...
const Premium = () => {
    ...
    return (
        <div className='heighter'>
            <div className='text-center border border-3 mx-auto py-5 rounded-5 mb-5 premium-container'>
                ...
                <div>
                    <p><FaCheck className='text-primary me-2'></FaCheck>Life Time Membership.</p>
                    <p><FaCheck className='text-primary me-2'></FaCheck>Access to All Courses</p>
                    <p><FaCheck className='text-primary me-2'></FaCheck>Course Video Download Access</p>
                    <p><FaCheck className='text-primary me-2'></FaCheck>Exam Access</p>
                    <p><FaCheck className='text-primary me-2'></FaCheck>Cirtificate</p>
                </div>
